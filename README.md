...
Do you want this, but don't have a Pi? Check out the [non-ARM version](https://github.com/mvance/unbound-docker).

## Supported tags and respective `Dockerfile` links

- [`1.16.0`, `latest` (*1.16.0/Dockerfile*)](https://github.com/sgaduuw/unbound-docker-rpi/tree/master/1.16.0)
- [`1.15.0`, (*1.15.0/Dockerfile*)](https://github.com/sgaduuw/unbound-docker-rpi/tree/master/1.15.0)
...
Pull this container:
`docker pull sgaduuw/unbound-rpi:latest`
...
*Note: See https://github.com/sgaduuw/unbound-docker-rpi/issues/8 for more background.*
...
Documentation for this image is stored right here in the [`README.md`](https://github.com/sgaduuw/unbound-docker-rpi/blob/master/README.md).
...
through a [GitHub issue](https://github.com/sgaduuw/unbound-docker-rpi/issues).
...
file](https://github.com/sgaduuw/unbound-docker-rpi/blob/master/README.md)
before attempting a pull request.

Before you start to code, I recommend discussing your plans through a [GitHub
issue](https://github.com/sgaduuw/unbound-docker-rpi/issues), especially for
...
file](https://github.com/sgaduuw/unbound-docker-rpi/blob/master/LICENSE) for
details.
